...
public class Base {
	...
	static {
		...
		try {
			...
			rootGMX509Certificate=PublicKeyTool.loadX509Certificate(Base64.getDecoder().decode(rootGMCert));
			...
			rootRSAX509Certificate=PublicKeyTool.loadX509Certificate(Base64.getDecoder().decode(rootRSACert));
